...
namespace DVLD_Buisness
{
    public class clsTestType
    {
        ...
        {
            string Description = ""; float Fees = 0;
            int TestTypeID = 0;

            if (clsTestTypeData.GetTestTypeInfoByTitle(ref TestTypeID, Title, ref Description, ref Fees))
        ...
        public static int GetCountOfTestTypes()
            => clsTestTypeData.GetCountOfTestTypes();
