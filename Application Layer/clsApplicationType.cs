...
namespace DVLD_Buisness
{
    public class clsApplicationType
    {
        ...
        public static DataTable GetApplicationTypesBy(int PageNumber, int RowPerPage) => clsApplicationTypeData.GetApplicationTypesBy(PageNumber, RowPerPage);
        ...
        public static int GetNumberOfRows() => clsApplicationTypeData.GetNumberOfRowsForAppTypes();
