...
namespace DVLD.Tests
{
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        void _FilldgvLocalDrivingLicenseApplications(int NumberOfPage)
        {
            _dtAllLocalDrivingLicenseApplications = clsLocalDrivingLicenseApplication.GetLocalDrivingLicenseApplicationsBy(NumberOfPage, 8);
        ...
        private void frmListLocalDrivingLicesnseApplications_Load(object sender, EventArgs e)
        {
            ...
            ctrlSwitchSearch1.MaxNumberOfPage = clsGet.GetMaximamPage(clsLocalDrivingLicenseApplication.GetNumberOfRows(), 8);
            ctrlSwitchSearch1.NumberOfPage = 1;
            _FilldgvLocalDrivingLicenseApplications(ctrlSwitchSearch1.NumberOfPage);
            ...
            if (dgvLocalDrivingLicenseApplications.Rows.Count>0)
            {
               ...
               // dgvLocalDrivingLicenseApplications.Columns[4].Width = 170;
                ...
                dgvLocalDrivingLicenseApplications.Columns[7].HeaderText = "Payment ID";
        ...
        {
            if (!clsGlobal.CurrentEmployee.CheckAccessPermision(clsEmployee.enPermision.EditApplication))
            {
                clsGlobal.PermisionMessage("EditApplication");
                return;
            }
        ...
        private void cmsApplications_Opening(object sender, CancelEventArgs e)
        {
            ...
            editToolStripMenuItem.Enabled = !LicenseExists && (LocalDrivingLicenseApplication.ApplicationInfo.ApplicationStatus == clsApplication.enApplicationStatus.New);
            ...
            DeleteApplicationToolStripMenuItem.Enabled =
                (LocalDrivingLicenseApplication.ApplicationInfo.ApplicationStatus == clsApplication.enApplicationStatus.New);
            ...
            ScheduleTestsMenue.Enabled = (!PassedVisionTest || !PassedWrittenTest || !PassedStreetTest) && (LocalDrivingLicenseApplication.ApplicationInfo.ApplicationStatus == clsApplication.enApplicationStatus.New);
            ...
            showBillInfoToolStripMenuItem.Enabled = dgvLocalDrivingLicenseApplications.CurrentRow.Cells[7].Value != DBNull.Value;
        ...
        {
            if (!clsGlobal.CurrentEmployee.CheckAccessPermision(clsEmployee.enPermision.DeleteApplication))
            {
                clsGlobal.PermisionMessage("DeleteApplication");
                return;
            }
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmShowPersonLicenseHistory frm = new frmShowPersonLicenseHistory(localDrivingLicenseApplication.ApplicationInfo.ApplicantPersonID);
            frm.ShowDialog();
        }
        ...
        {
            _FilldgvLocalDrivingLicenseApplications(e.CurrentNumberOfPage);
        }
        ...
        private void cbStatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ctrlSwitchSearch1.Visible = false;
                _dtAllLocalDrivingLicenseApplications.DefaultView.RowFilter = string.Format("[{0}] = '{1}'", "Status", cbStatus.Text);
            }
            lblRecordsCount.Text = dgvLocalDrivingLicenseApplications.Rows.Count.ToString();
        }
        ...
        {
            int PaymentID = (int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[7].Value;
