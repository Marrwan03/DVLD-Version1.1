...
{
    public partial class ctrlCreditCard : UserControl
    {
        public ctrlCreditCard()
        {
            InitializeComponent();
        }
        bool _ShowBalance;
        public bool ShowBalance { get {return  _ShowBalance; } 
            set 
            {
                _ShowBalance = value;
        ...
        public clsCreditCard.enTypeOfCreditCard typeOfCreditCard 
        {
            ...
            set 
            {
                ...
                lblTypeOfCreditCard.Text = clsCreditCard.GetStringTypeOfCreditCard((byte)_typeOfCreditCard); 
            }
        }
        ...
        private void ctrlCreditCard_Load(object sender, EventArgs e)
        {
            ShowBalance = false;
