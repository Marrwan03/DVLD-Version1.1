...
namespace DVLD.Licenses.International_Licenses.Controls
{
    public partial class ctrlDriverInternationalLicenseInfo : UserControl
    {
        ...
        public void LoadInfo(int InternationalLicenseID)
        {
            ...
            lblRemainingDays.Text = new TimeSpan(_InternationalLicense.ExpirationDate.Ticks).Subtract(new TimeSpan(DateTime.Now.Ticks)).Days.ToString() + " Day(s).";
            lblIsDetained.Text = _InternationalLicense.IsDetained ? "Yes" : "No";
            lblIssueReason.Text = _InternationalLicense.ApplicationInfo.ApplicationTypeInfo.Title;
