...
namespace DVLD.DriverLicense
{
    public partial class ctrlDriverLicenseInfo : UserControl
    {
        ...
        public void LoadInfo(int LicenseID)
        {
            ...
            lblRemainingDays.Text = new TimeSpan(_License.ExpirationDate.Ticks).Subtract(new TimeSpan(DateTime.Now.Ticks)).Days.ToString()+" Day(s).";
        ...
        private void llblShowAppInfo_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            frmApplicationBasicInfo applicationBasicInfo = new frmApplicationBasicInfo(_License.ApplicationID);
